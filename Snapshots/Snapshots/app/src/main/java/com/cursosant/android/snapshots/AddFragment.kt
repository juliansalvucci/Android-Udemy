...
class AddFragment : Fragment() { //Fragmento para agregar imágenes
    ...
    private fun postSnapshot() {
        mBinding.progressBar.visibility = View.VISIBLE // ver el progresop de la suibida
        ...
        if (mPhotoSelectedUri != null) { //aSi hay foto, que la suba
            storageReference.putFile(mPhotoSelectedUri!!)
                    .addOnProgressListener {
                        val progress = (100 * it.bytesTransferred/it.totalByteCount).toDouble()
                        mBinding.progressBar.progress = progress.toInt() //Pintar barra de progreso mientras se sube.
