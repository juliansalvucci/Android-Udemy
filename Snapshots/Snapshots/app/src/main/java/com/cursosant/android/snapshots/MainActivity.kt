...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = ActivityMainBinding.inflate(layoutInflater) //se pueden acceder a los fratgmentos desde la actividad
    ...
    private fun setupBottomNav(){
        ...
        val homeFragment = HomeFragment() //Instancia de cada fragmento
        val addFragment = AddFragment()
        val profileFragment = ProfileFragment()

        mActiveFragment = homeFragment //fragmento home será el pincipal

        mFragmentManager.beginTransaction()
            .add(R.id.hostFragment, profileFragment, ProfileFragment::class.java.name)
            .hide(profileFragment).commit() //Anhñadir y ocultar fragmento
        mFragmentManager.beginTransaction()
            .add(R.id.hostFragment, addFragment, AddFragment::class.java.name)
            .hide(addFragment).commit()
        mFragmentManager.beginTransaction()
            .add(R.id.hostFragment, homeFragment, HomeFragment::class.java.name).commit()
        //Este no se oculta por que es el principal.
